...
public class Customer implements Serializable {
    ...
    public Customer streetName(String streetName) {
    ...
    public Customer orders(Set<BookOrder> bookOrders) {
        this.orders = bookOrders;
        return this;
    }

    public Customer addOrder(BookOrder bookOrder) {
        this.orders.add(bookOrder);
        bookOrder.setCustomer(this);
        return this;
    }

    public Customer removeOrder(BookOrder bookOrder) {
